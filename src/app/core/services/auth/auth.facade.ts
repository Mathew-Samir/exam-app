...
import { MsrAuth, AuthResponse, RegisterRequest, ForgotPasswordRequest, ResetPasswordRequest, SendEmailVerificationRequest, ConfirmEmailVerificationRequest, AuthData } from "msr-auth";
